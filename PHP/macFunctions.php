...
{   
    ...
    $from = 'sonkerankush123@gmail.com'; 
    $fromName = 'IIITA Admissions'; 
    $subject = "Admission Confirmation- Regarding.";
    $body = "Hello $name, \n\nWe are please to informed that you have been granted admission in the $programme programme. For more information like document verification proceress and admission letter, visit the admission portal and check into your account.\n\nNote: This is a system generated mail. So do not revert back to it.\n\nRegards,\nAdmission Committee, IIITA\n ";
    $headers = "From: $fromName"." <".$from.">"; 
    mail($toemail, $subject, $body, $headers);
