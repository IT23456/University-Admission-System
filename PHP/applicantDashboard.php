                ...
                <div class="col-md-2" style="background-color:#002147;">
                    ...
                    <form class="form-horizontal" action="/UAS/PHP/applicantFunctions.php" method="post">
                        ...
                        <?php if($_SESSION['status']=="Accepted"){?>
                            ...
                            <div class="row justify-content-around py-3">
                                <button class="btn btn-outline-info" name="interviewInfo"><b><span class="fa fa-paper-plane pr-3"></span>INTERVIEW DETAILS</b></button>
                            </div>

                        <?php } ?>

                            <div class="row justify-content-around py-3">
                                <button class="btn btn-outline-info" name="emailForm"><b><span class="fa fa-envelope-open pr-3"></span>EMAIL THE REPORT</b></button>
                            </div>
                            <div class="row justify-content-around py-3">
